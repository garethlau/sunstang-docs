...
import {AtomicBlockUtils, EditorState, convertToRaw, RichUtils} from 'draft-js';
import Editor, { composeDecorators } from "draft-js-plugins-editor";
import createImagePlugin, {Entity} from "draft-js-image-plugin";
...
const readImageAsDataUrl = (image, callback) => {
    console.log("in readingimageasdataurl")
...
const insertImageIntoEditor = (editorState, base64) => {
    console.log("inserting into editor")
    const contentState = editorState.getCurrentContent();
    const entityKey = contentState.createEntity('IMAGE', 'IMMUTABLE', { src: base64 });
...
class PageCreator extends Component {
  ...
  handlePastedFiles = (files) => {
      console.log("the pasted file is", files[0]);
    ...
    render() {
        return(
            <div className="editor-container">
                ...
                <button onClick={this.addTwitter}>Add twitter</button>
